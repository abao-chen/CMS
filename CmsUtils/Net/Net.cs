...
namespace CmsUtils
{
    ...
    public class Net
    {
        ...
        public static string GetLocation(string ip)
        {
            ...
            try
            {
                var url = "http://apis.juhe.cn/ip/ip2addr?ip=" + ip +
                          "&dtype=json&key=b39857e36bee7a305d55cdb113a9d725";
            ...
            try
            {
                var url = "https://sp0.baidu.com/8aQDcjqpAAV3otqbppnN2DJv/api.php?query=" + ip +
                          "&resource_id=6006&ie=utf8&oe=gbk&format=json";
