...
<div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtDescription" searchattr="Description|=|Description" CssClass="form-control" placeholder="描述"></asp:TextBox>
                            </div> 
<div class="col-lg-4 form-group">
    ...
    <div class="row" style="padding-bottom: 5px;">
        <div class="col-lg-12">
            <a id="btnAdd" class="btn btn-info" href="/#Folder#/DicTypeInfo.aspx"><span class="glyphicon glyphicon-plus"></span>新增</a>
            ...
            tableObj = $('#dataTables').DataTable({
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, row, meta) {
                            var result = "<a href=\"/#Folder#/DicTypeInfo.aspx?Id=" + data + "\" style='margin-left:10px;'><span class='glyphicon glyphicon-edit' title='编辑'></span></a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:deleteRows('" + data + "');\"><span class='glyphicon glyphicon-trash' title='删除'></span></a>";
                            return result;
                        }
                    },
                    { "data": "DicTypeCode" },
