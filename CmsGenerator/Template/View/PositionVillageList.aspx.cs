...
namespace CmsWeb
{
    public partial class PositionVillageList : BasePage
    {
        ...
        protected void btnExport_OnClick(object sender, EventArgs e)
        {
            ...
            string sql = @"SELECT
				            ...
				            WHERE
					            isdeleted = 0 ";
            DataTable dt = new PositionVillageBal().GetDataTable(searchModel, sql);
            string filePath = Server.MapPath("~/Temp/" + DateTime.Now.ToString("yyyyMMdd"));
            string fileName = "PositionVillageList_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
