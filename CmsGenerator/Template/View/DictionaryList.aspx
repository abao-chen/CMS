                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtDicTypeCode" searchattr="DicTypeCode|=|DicTypeCode" CssClass="form-control" placeholder="字典类型编码"></asp:TextBox>
                            </div> 
<div class="col-lg-4 form-group">
...
<div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtIsUsing" searchattr="IsUsing|=|IsUsing" CssClass="form-control" placeholder="是否启用
            1：启用，0：未启用"></asp:TextBox>
                            </div> 
    ...
    <div class="row" style="padding-bottom: 5px;">
        <div class="col-lg-12">
            <a id="btnAdd" class="btn btn-info" href="/#Folder#/DictionaryInfo.aspx"><span class="glyphicon glyphicon-plus"></span>新增</a>
            ...
            tableObj = $('#dataTables').DataTable({
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, row, meta) {
                            var result = "<a href=\"/#Folder#/DictionaryInfo.aspx?Id=" + data + "\" style='margin-left:10px;'><span class='glyphicon glyphicon-edit' title='编辑'></span></a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:deleteRows('" + data + "');\"><span class='glyphicon glyphicon-trash' title='删除'></span></a>";
                            return result;
                        }
                    },
                    { "data": "DicTypeCode" },
