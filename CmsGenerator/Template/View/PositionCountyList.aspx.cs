...
namespace CmsWeb
{
    public partial class PositionCountyList : BasePage
    {
        ...
        protected void btnExport_OnClick(object sender, EventArgs e)
        {
            ...
            string sql = @"SELECT
				            ...
				            WHERE
					            isdeleted = 0 ";
            DataTable dt = new PositionCountyBal().GetDataTable(searchModel, sql);
            string filePath = Server.MapPath("~/Temp/" + DateTime.Now.ToString("yyyyMMdd"));
            string fileName = "PositionCountyList_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
