<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="PositionVillageList.aspx.cs" Inherits="CmsWeb.PositionVillageList" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtTownID" searchattr="TownID|=|TownID" CssClass="form-control" placeholder="镇id"></asp:TextBox>
                            </div> 
<div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtVillageID" searchattr="VillageID|=|VillageID" CssClass="form-control" placeholder="村id--唯一"></asp:TextBox>
                            </div> 
<div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtVillageName" searchattr="VillageName|=|VillageName" CssClass="form-control" placeholder="村名称"></asp:TextBox>
                            </div> 
    ...
    <div class="row" style="padding-bottom: 5px;">
        <div class="col-lg-12">
            <a id="btnAdd" class="btn btn-info" href="/#Folder#/PositionVillageInfo.aspx"><span class="glyphicon glyphicon-plus"></span>新增</a>
        ...
        $(function () {
            tableObj = $('#dataTables').DataTable({
                ...
                "ajax": function (data, callback) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/API/PositionVillageApi.aspx",
                        cache: false,  //禁用缓存
                        data: param,  //传入组装的参数
                        dataType: "json",
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, row, meta) {
                            var result = "<a href=\"/#Folder#/PositionVillageInfo.aspx?Id=" + data + "\" style='margin-left:10px;'><span class='glyphicon glyphicon-edit' title='编辑'></span></a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:deleteRows('" + data + "');\"><span class='glyphicon glyphicon-trash' title='删除'></span></a>";
                            return result;
                        }
                    },
                    { "data": "TownID" },
