<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="OrganizationList.aspx.cs" Inherits="CmsWeb.OrganizationList" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtParentID" searchattr="ParentID|=|ParentID" CssClass="form-control" placeholder="父级组织ID"></asp:TextBox>
                            </div> 
<div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtFullID" searchattr="FullID|=|FullID" CssClass="form-control" placeholder="组织全路径"></asp:TextBox>
                            </div> 
    ...
    <div class="row" style="padding-bottom: 5px;">
        <div class="col-lg-12">
            <a id="btnAdd" class="btn btn-info" href="/#Folder#/OrganizationInfo.aspx"><span class="glyphicon glyphicon-plus"></span>新增</a>
            ...
            tableObj = $('#dataTables').DataTable({
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, row, meta) {
                            var result = "<a href=\"/#Folder#/OrganizationInfo.aspx?Id=" + data + "\" style='margin-left:10px;'><span class='glyphicon glyphicon-edit' title='编辑'></span></a>&nbsp;&nbsp;&nbsp;<a href=\"javascript:deleteRows('" + data + "');\"><span class='glyphicon glyphicon-trash' title='删除'></span></a>";
                            return result;
                        }
                    },
                    { "data": "ParentID" },
