...
namespace CmsWeb
{
    public partial class PositionCityList : BasePage
    {
        ...
        protected void btnExport_OnClick(object sender, EventArgs e)
        {
            ...
            string sql = @"SELECT
				            ...
				            WHERE
					            isdeleted = 0 ";
            DataTable dt = new PositionCityBal().GetDataTable(searchModel, sql);
            string filePath = Server.MapPath("~/Temp/" + DateTime.Now.ToString("yyyyMMdd"));
            string fileName = "PositionCityList_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
