...
namespace CmsWeb
{
    public partial class PositionProviceList : BasePage
    {
        ...
        protected void btnExport_OnClick(object sender, EventArgs e)
        {
            ...
            string sql = @"SELECT
				            ...
				            WHERE
					            isdeleted = 0 ";
            DataTable dt = new PositionProviceBal().GetDataTable(searchModel, sql);
            string filePath = Server.MapPath("~/Temp/" + DateTime.Now.ToString("yyyyMMdd"));
            string fileName = "PositionProviceList_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
