...
namespace CmsBAL
{
    ...
    public class PositionCountyBal : BaseBal<TB_PositionCounty>
    {
        /// <summary>
        /// 删除数据
        /// </summary>
    ...
    public void DeleteByIds(AjaxResultModel resultModel, AjaxModel searchModel)
    {
        ...
        List<TB_PositionCounty> list = new List<TB_PositionCounty>();
        using (var ctx = new CmsEntities())
        {
            PositionCountyDal dal = new PositionCountyDal(ctx);
            ...
            foreach (string i in ids)
            {
                ...
                {
                    TB_PositionCounty entity = dal.SelectSingle(u => u.ID.Equals(id));
                    if (entity != null)
                    {
                        entity.IsDeleted = 1;
                        list.Add(entity);
