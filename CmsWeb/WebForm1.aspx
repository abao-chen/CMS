<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CmsWeb.WebForm1" %>
...
<head runat="server">
    ...
    <title>Bootstrap Admin Master</title>
    ...
    <%--<script src="/Scripts/bootstrap/vendor/bootstrap-validator/vendor/bootstrap/js/bootstrapValidator.min.js"></script>--%>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal" action="target.php">
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control" name="ctl00$ContentPlaceHolder1$firstName" placeholder="First name" />
                            </div>
                            <div class="col-lg-4">
                                <input type="text" class="form-control" name="ctl00$ContentPlaceHolder1$lastName" placeholder="Last name" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="programs[]" value="net" />
                                        .Net
                                    </label>
                                </div>
                                <div class="checkbox">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="programs[]" value="javascript" />
                                        Javascript
                                    </label>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#validateBtn').click(function () {
                console.log($('#defaultForm').bootstrapValidator('validate'));
            });
        });
    </script>
</body>
