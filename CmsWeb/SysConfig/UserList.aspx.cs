...
namespace CmsWeb
{
    public partial class UserList : BasePage
    {
        ...
        {
            ControlUtil.BindDropDownList(this.ddlUserStatus, new DictionaryBal().GetDictionaryList(Constants.DIC_TYPE_USERSTATUS), true);
            ControlUtil.BindDropDownList(this.ddlUserType, new DictionaryBal().GetDictionaryList(Constants.DIC_TYPE_USERTYPE), true);
        }
        ...
        protected void btnExport_OnClick(object sender, EventArgs e)
        {
            ...
            long fileLength = ExcelUtil.WriteExcel(dt, filePath, fileName, new string[] { "ID", "UserType", "UserStatus" });
            if (fileLength > 0)
            {
