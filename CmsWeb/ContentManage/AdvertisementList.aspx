                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-4 form-group">
                                <asp:DropDownList runat="server" ID="ddlAdTypeID" searchattr="AdTypeID|LIKE|AdTypeID" CssClass="form-control" placeholder="广告类型ID"></asp:DropDownList>
                            </div>
                            <div class="col-lg-4 form-group">
                                <asp:TextBox runat="server" ID="txtAdName" searchattr="AdName|LIKE|AdName" CssClass="form-control" placeholder="广告名称"></asp:TextBox>
                            </div>
