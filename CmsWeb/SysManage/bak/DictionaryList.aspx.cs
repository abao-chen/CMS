...
namespace CmsWeb
{
    public partial class DictionaryList : BasePage
    {
        ...
        {
            ControlUtil.BindListControl(this.ddlDicTypeCode, new DicTypeBal().SelectList(d => d.IsDeleted != Constants.IS_YES && d.IsUsing == Constants.IS_YES).ToList(), "DicTypeName", "DicTypeCode", true);
        }
