...
{
    public partial class DicTypeList : BasePage
    {
        ...
        protected void btnExport_OnClick(object sender, EventArgs e)
        {
            ...
            string sql = @"SELECT
				            ...
				            WHERE
					            isdeleted = 0 ";
            DataTable dt = new DicTypeBal().GetDataTable(searchModel, sql);
            string filePath = Server.MapPath("~/Temp/" + DateTime.Now.ToString("yyyyMMdd"));
            string fileName = "DicTypeList_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
